            ...
            <Form onSubmit={this.handleSubmit}>
                <FormItem label={`用户id`}   {...formItemLayout} >
                    {getFieldDecorator('userId', {
                        ...
                        <Input className={'edit-input-view'} placeholder=""  disabled={this.props.itemData}/>
                    )}
                </FormItem>
                ...
                <FormItem
                    ...
                    {getFieldDecorator('apiKey', {
                        ...
                        <Input className={'edit-input-view'} disabled={this.props.itemData}/>
                    )}
                </FormItem>
                <FormItem
                ...
                <FormItem  {...formItemLayout} label={`状态`}>
                    {getFieldDecorator('status', {
                        ...
                        <Select
                            ...
                            placeholder="状态"
                        >
                            <Option key='android' value={0}>禁用</Option>
                            <Option key='ios' value={1}>启用</Option>
                        </Select>
                    )}
                </FormItem>
