...
class CoinDoubleTradeDetail extends Component {
    ...
    setFormValue = () => {
        if (this.itemData) {
            console.log(this.itemData)
            console.log(typeof (this.itemData.recommend))
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <div className='cdtd-item-row'>
                    ...
                    <div className='cdtc-note'>备注：币对在前台现实的顺序</div>
                </div>
                {/*<div className='cdtd-item-row'>*/}
                {/*<div className='flex-1'/>*/}
                {/*<FormItem*/}
                ...
                {/*)}*/}
                {/*</FormItem>*/}
                {/*<div className='cdtc-note'>备注：杠杆倍数至少需要三级，使用`,`分隔</div>*/}
                {/*</div>*/}
                <div className='cdtd-item-row'>
                    <div className='flex-1'/>
                    ...
                    <FormItem className='cdtc-form-item' label={`板块选择`}>
                        {getFieldDecorator('merge', {
                            ...
                            <Select
                                style={{width: '250px'}}
                            >
                                <Option value={0}>淘金板块</Option>
                                <Option value={1}>标准板块</Option>
                            </Select>
                        )}
                    </FormItem>
                    <div className='cdtc-note'></div>
                ...
                {/*<div className='cdtc-note'>备注：</div>*/}
                {/*</div>*/}
                {/*<div className='cdtd-item-row'>*/}
                {/*<div className='flex-1'/>*/}
