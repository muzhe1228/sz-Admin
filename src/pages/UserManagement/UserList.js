        ...
        return (
            <div style={{display: 'flex', flexDirection: 'column', marginTop: '20px', marginBottom: '20px'}}>
                <div className='row-user'>
                    <Button onClick={this.showModal} style={{marginRight: '5px', marginLeft: '5px'}}>用户权限</Button>
                    ...
                    <Button onClick={this.onResetTrade} style={{marginRight: '5px', marginLeft: '5px'}}>重置支付密码</Button>
