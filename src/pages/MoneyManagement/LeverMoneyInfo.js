...
import {hlList, getDickey} from '../../requests/http-req.js'
    ...
    renderUserList = () => {
        ...
        return (
            <Spin spinning={this.state.showLoading}>
                {/*<Button onClick={this.showModal} style={{marginRight: '5px', marginLeft: '5px'}}>添加</Button>*/}
                {/*<Button onClick={this.onKickDown}*/}
                {/*style={{marginRight: '5px', marginLeft: '5px'}}>踢下线</Button>*/}
                {/*<Button onClick={this.onResetLogin} style={{marginRight: '5px', marginLeft: '5px'}}>重置登录密码</Button>*/}
                {/*<Button onClick={this.onResetTrade} style={{marginRight: '5px', marginLeft: '5px'}}>重置资金密码</Button>*/}
                {/*<Button onClick={this.onResetGoogle}*/}
                {/*style={{marginRight: '5px', marginLeft: '5px'}}>重置google</Button>*/}
