...
const coinType = [{"dicKey": 10010065, "dicName": "人工加币"}, {"dicKey": 10010070, "dicName": "人工减币"}]
export default class AddAndSubtractDetail extends Component {
    ...
    postData() {
        ...
        mhSave(temArr).then((req) => {
            ...
            if (req.status == 200) {
                ...
                this.setState({coinCode: null, mhType: null, mhAmount: null, remark: null})
            }
        })
    }
    ...
    handleSubmit = () => {
        if (this.state.userId == null || this.state.mhAmount == null || this.state.mhType == null || this.state.coinCode == null || this.state.remark == null) {
        ...
        return (
            <div className='center-user-list'>
                ...
                >
                    ...
                    <FormItem style={{margin: 'auto', paddingRight: '15px',paddingLeft: 28, width: '360px', height: '60px'}}
                              label={`备注`}>
                        <Input
                            type='text'
                            value={this.state.remark}
                            placeholder="备注"
                            onChange={this.inputRemarkChange}/>
                    </FormItem>
