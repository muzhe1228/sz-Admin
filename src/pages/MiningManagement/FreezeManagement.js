...
export default class FreezeManagement extends Component {
    constructor(props) {
        super(props);
        this.state = {
            listData: [],
