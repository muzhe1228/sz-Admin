...
class BannerEdit extends Component {
    ...
    handleSubmit = () => {
        const {picPath, url, sortOrder, enabled, lang, type, name} = this.state
        //console.log(this.state)

        if (picPath == null || sortOrder == null || enabled == null || lang == null || enabled == null || type == null || name == null) {
...
//
    ...
    // onUploadProgress = (e) => {
    //     console.log()
    //     e.onProgress((e.total / e.loaded) * 100)
    // }
