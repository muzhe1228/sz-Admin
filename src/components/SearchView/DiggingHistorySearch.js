...
class DiggingHistorySearch extends Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
            ...
            >
                <div style={{display: 'flex', alignItems: 'center'}}>
                    <Row gutter={24}>
                        ...
                        <Col span={8} key={5}>
                            <FormItem style={{margin: 'auto', flex: 1, width: '250px', paddingRight: '25px'}} label={`用户ID`}>
...
const NewDiggingHistorySearch = Form.create()(DiggingHistorySearch);
export default NewDiggingHistorySearch;
