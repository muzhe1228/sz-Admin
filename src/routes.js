...
import SettleTask from './pages/MiningManagement/SettleTask'
import NodeManagement from './pages/MiningManagement/NodeManagement'
import FreezeManagement from './pages/MiningManagement/FreezeManagement'
import PoundageToday from './pages/MiningManagement/PoundageToday'
import PoundageHistory from './pages/MiningManagement/PoundageHistory'
import DiggingToday from './pages/MiningManagement/DiggingToday'
import DiggingHistory from './pages/MiningManagement/DiggingHistory'
import DividendRecords from './pages/MiningManagement/DividendRecords'
import Config from './pages/MiningManagement/Config'
import UserRecommed from './pages/MiningManagement/UserRecommed'
import UserCommission from './pages/MiningManagement/UserCommission'
...
export const routes = [
    ...
    {component: SettleTask, path: '/index/MiningManagement/SettleTask'},
    {component: NodeManagement, path: '/index/MiningManagement/NodeManagement'},
    {component: FreezeManagement, path: '/index/MiningManagement/FreezeManagement'},
    {component: PoundageToday, path: '/index/MiningManagement/PoundageToday'},
    {component: PoundageHistory, path: '/index/MiningManagement/PoundageHistory'},
    {component: DiggingToday, path: '/index/MiningManagement/DiggingToday'},
    {component: DiggingHistory, path: '/index/MiningManagement/DiggingHistory'},
    {component: DividendRecords, path: '/index/MiningManagement/DividendRecords'},
    {component: Config, path: '/index/MiningManagement/Config'},
    {component: UserRecommed, path: '/index/MiningManagement/UserRecommed'},
    {component: UserCommission, path: '/index/MiningManagement/UserCommission'},
]
...
export const breadcrumbNameMap = {
    ...
    '/index/MiningManagement': '挖矿分红管理',
    '/index/MiningManagement/SettleTask': '结算任务列表',
    '/index/MiningManagement/NodeManagement': '数字节点管理',
    '/index/MiningManagement/FreezeManagement': '锁仓管理',
    '/index/MiningManagement/PoundageToday': '今日手续费明细',
    '/index/MiningManagement/PoundageHistory': '历史手续费明细',
    '/index/MiningManagement/DiggingToday': '今日挖矿明细',
    '/index/MiningManagement/DiggingHistory': '历史挖矿明细',
    '/index/MiningManagement/DividendRecords': '分红记录',
    '/index/MiningManagement/Config': '参数设置',
    '/index/MiningManagement/UserRecommed': '邀请管理',
    '/index/MiningManagement/UserCommission': '返佣管理',
};
